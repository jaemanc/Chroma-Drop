...
public class StageSetting
{
    ...
    // pieceLimit 은 목표가 아니라 조건이다 — 어떤 목표와도 섞인다.
...
public static class StageTable
{
    ...
    static readonly float[] BudgetMul = { 1.30f, 1.15f, 1.00f, 0.90f, 0.80f };  // 수·피스
    static readonly float[] TimeMul   = { 1.40f, 1.20f, 1.00f, 0.85f, 0.70f };  // 조각 제한 시간
    static readonly float[] HazardMul = { 0.50f, 0.75f, 1.00f, 1.25f, 1.50f };  // 벽돌 수
